...
/// Consensus contract client for AndeConsensusV2 integration.
pub mod consensus_client;

/// Block attestation module for signing and submitting blocks.
pub mod attestation;
...
pub use attestation::BlockAttester;
...
pub use consensus_client::{AndeConsensusClient, Phase, ValidatorInfo};
